...
<div className="container mx-auto" style={{ maxWidth: "900px" }}>
  ...
  <div className="container">
    <div className="row">
      ...
      <div className="col-md-5" style={{ minWidth: "400px" }}>
        <img src="https://spotify-recently-played-readme.vercel.app/api?user=yude1119&unique=true&width=400&count=8" />
      </div>
    </div>
  </div>
</div>
...
- [広島市立大学](https://www.hiroshima-cu.ac.jp/) [情報科学部](https://www2.info.hiroshima-cu.ac.jp/) (2020/4 -) 学部 4 年
  - 学科 / 研究室
    ...
    - [センシング講座 情報ネットワーク研究グループ](http://www.net.info.hiroshima-cu.ac.jp/) (2023/4 -)
  - サークル / クラブ
